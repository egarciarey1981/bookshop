...
use Bookshop\Catalog\Domain\Subscriber\DomainEventSubscriber as SubscriberDomainEventSubscriber;

final class UpdateNumberOfBooksByGenreSubscriber implements SubscriberDomainEventSubscriber
{
